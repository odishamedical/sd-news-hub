    ...
    <div className="flex h-[calc(100vh-40px)] bg-[#0A0F1C] text-gray-200 overflow-hidden font-sans">
      ...
      <aside className="w-64 bg-[#050810] border-r border-[#1C2438] flex flex-col shrink-0">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <Link href="/admin/bulk-invites" className="w-full flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-white rounded-lg font-medium transition-colors hover:bg-[#1C2438]/20">
