...
import { getFirestore, collection, getDocs, addDoc, serverTimestamp, query, orderBy, doc, updateDoc } from "firebase/firestore";
...
export { app, db, collection, getDocs, addDoc, serverTimestamp, query, orderBy, doc, updateDoc };
